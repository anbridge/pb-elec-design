...
ICM_20948_Status_e icm20948_startup_magnetometer(bool minimal)
{
  ...
  /*else
  {
    debugPrint(F("icm20948_startupMagnetometer: successful magWhoIAm after "));
...
ICM_20948_Status_e icm20948_startup_default(bool minimal)
{
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("icm20948_startupDefault: checkID returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
...
//Gyro Bias
ICM_20948_Status_e icm20948_set_bias_gyro_x( int32_t newValue)
{
    ...
    status = icm20948_write_mem(GYRO_BIAS_X, 4, (const unsigned char*)&gyro_bias_reg);
    return status;
}

ICM_20948_Status_e icm20948_set_bias_gyro_y( int32_t newValue)
{
    ...
    gyro_bias_reg[2] = (unsigned char)(newValue >> 8);
    gyro_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = icm20948_write_mem(GYRO_BIAS_Y, 4, (const unsigned char*)&gyro_bias_reg);
    return status;
}

ICM_20948_Status_e icm20948_set_bias_gyro_z( int32_t newValue)
{
...
//Accel Bias
ICM_20948_Status_e icm20948_set_bias_accel_x( int32_t newValue)
{
    ...
    status = icm20948_write_mem(ACCEL_BIAS_X, 4, (const unsigned char*)&accel_bias_reg);
    return status;
}

ICM_20948_Status_e icm20948_set_bias_accel_y( int32_t newValue)
{
    unsigned char accel_bias_reg[4];
    accel_bias_reg[0] = (unsigned char)(newValue >> 24);
    accel_bias_reg[1] = (unsigned char)(newValue >> 16);
    accel_bias_reg[2] = (unsigned char)(newValue >> 8);
    accel_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = icm20948_write_mem(ACCEL_BIAS_Y, 4, (const unsigned char*)&accel_bias_reg);
    return status;
}

ICM_20948_Status_e icm20948_set_bias_accel_z( int32_t newValue)
{
...
//CPass Bias
ICM_20948_Status_e icm20948_set_bias_cpass_x( int32_t newValue)
{
    ...
    status = icm20948_write_mem(CPASS_BIAS_X, 4, (const unsigned char*)&cpass_bias_reg);
    return status;
}

ICM_20948_Status_e icm20948_set_bias_cpass_y( int32_t newValue)
{
    unsigned char cpass_bias_reg[4];
    cpass_bias_reg[0] = (unsigned char)(newValue >> 24);
    cpass_bias_reg[1] = (unsigned char)(newValue >> 16);
    cpass_bias_reg[2] = (unsigned char)(newValue >> 8);
    cpass_bias_reg[3] = (unsigned char)(newValue & 0xff);
    status = icm20948_write_mem(CPASS_BIAS_Y, 4, (const unsigned char*)&cpass_bias_reg);
    return status;
}

ICM_20948_Status_e icm20948_set_bias_cpass_z( int32_t newValue)
{
    unsigned char cpass_bias_reg[4];
    cpass_bias_reg[0] = (unsigned char)(newValue >> 24);
    cpass_bias_reg[1] = (unsigned char)(newValue >> 16);
